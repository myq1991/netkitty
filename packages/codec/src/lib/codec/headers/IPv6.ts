...
import {BufferToIPv6} from '../../helper/BufferToIP'
...
export class IPv6 extends BaseHeader {
    ...
    public match(): boolean {
        ...
        if ((this.prevCodecModule.id === 'geneve' || this.prevCodecModule.id === 'gre') && this.prevCodecModule.instance.protocolType.getValue() === UInt16ToHex(0x86dd)) return true
        return false
    }
