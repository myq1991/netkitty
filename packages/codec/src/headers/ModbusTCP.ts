 ...
 */
export class ModbusTCP extends BaseHeader {
        ...
        return {
            ...
            properties: {
                ...
                length: {
                    ...
                    minimum: 0,
                    maximum: 65535,
                    decode: function (this: ModbusTCP): void {
                        this.instance.length.setValue(BufferToUInt16(this.readBytes(4, 2)))
                    },
                    encode: function (this: ModbusTCP): void {
    ...
    public readonly id: string = 'modbus'

    public readonly name: string = 'Modbus/TCP'

    public readonly nickname: string = 'Modbus'

    public readonly matchKeys: string[] = ['tcpport:502']
